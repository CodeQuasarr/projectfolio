            ...
            <div class="presentation--card d-flex flex-wrap align-items-center justify-content-around">
                ...
                <div class="text-white col-11 col-md-8 col-lg-7 presentation--card_content">
                    <div class="presentation--card_content_text">
                        <h1>Conception <br> Development, <br> Faire de vos rêve une réalité </h1>
                    </div>
                    <div class="separator"></div>
                    <div class=" presentation--card_content_label">
                        <span>Mon but ?</span>
                        <span>Apporter un plus à votre entreprise.</span>
                        <span>Ma patience, ma curiosité et mon sens d'adaptation seront des atouts qui me permettront d'amener à bien <br/> mes missions au sein de votre enseigne.</span>
                    </div>
                </div>
                <!--end title-->
                <!--cv-->
        ...
        <div id="profil" style="min-height:100vh" class=" container-fluid bg-light d-flex align-items-center">
            <div class="container mx-auto show">
                <h3>Presentation & competences</h3>
                <div class="row d-flex align-items-center justify-content-center mt-5">
                    <div class="col-lg-5 show-9 mx-auto about-me">
                        <div class="text-center my-5">
                            <img class="img-fluid rounded rounded-circle " width="150" src="public/images/portfolio/man.jpg" alt="">
                        </div>
                        <p>Je suis ANYARONKE Samuel, étudiant en licence 3 Informatique.J'ai commencer le web en 2020; J'ai appris et je continu à apprendre le développement web en autodidacte, spécialisé dans le PHP et le framework Symfony (je debute le
                            symfony). Je suis aussi parfaitement à l’aise avec le HTML / CSS / JavaScript. J'aime le sport surtout le basket-ball (joueur en club), me tenir informé des dernières nouveautés et suivre la NBA.
                        </p>
                    </div>
                    <div class="col-lg-5 mx-auto">
                        <div class="col-12">
                            ...
                            <div class="row techno justify-content-around">
                                <div class="col-6 show-1 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-2 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-3 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-4 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-5 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-6 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                            ...
                            <h4>Outils</h4>
                            <div class="row techno justify-content-around">
                                <div class="col-6 show-7 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-8 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                            ...
                            <div class="row techno justify-content-around">
                                <div class="col-6 show-9 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                                ...
                                <div class="col-6 show-10 bg-white border border-light d-flex align-items-center justify-content-around p-3 about-techno">
                ...
                <div class="row d-flex align-items-center justify-content-center mt-5">
                    ...
                    <div class="card rightLeft-10  bg-dark text-white p-0">
                        ...
                        <div class="d-none card-img-overlay d-flex flex-column align-items-center  justify-content-around">
                            ...
                            <a class="btn btn-light" href="#">VISITER</a>
                        </div>
                    </div>
                    ...
                    <div class="card rightLeft-8 bg-dark text-white p-0">
                        ...
                        <div class="d-none card-img-overlay">
        ...
        <div style="min-height:100vh" class="container-fluid bg-light d-flex align-items-center ">
            <div class="col-md-6 mx-auto show">
                <h3 class="text-center text-secondary">Démarrons l'aventure ensemble, n"hésiter pas à me contacter</h3>
                <div class="row d-flex align-items-center justify-content-center mt-5">

                    <!--contact-->
                    <form id="myform" method="post" action="send-mail" class="show-2 form-floating col-11">

                        <div class="form-floating mb-3 ">
                            <input type="text" class="form-control px-4 rounded-pill" id="name" name="name" placeholder="Votre nom">
                        ...
                        <div class="mb-3 row ">
                            <div class="form-floating mb-3 col-12 col-md-6 ">
                                <input type="email" class="form-control px-4 rounded-pill" id="email" name="email" placeholder="Votre email">
                            ...
                            <div class="form-floating mb-3 col-12 col-md-6 ">
                                <input type="text" class="form-control px-4 rounded-pill" id="phone" name="phone" placeholder="Votre numero de telephone">
                        ...
                        <div class="form-floating mb-2">
                            <textarea class="form-control px-4" placeholder="Leave a comment here" id="message" name="message" style="height: 200px"></textarea>
                            <label for="floatingTextarea2">Taper Votre message ici</label>
                        </div>
                        <div class="form-floating mb-3 col-12 col-md-6 ">
                            <img width="200" height="100" class="text-center" src="public/images/logo/valid.png" alt="...">
                            <label for="floatingTextarea2">Entrez le texte suivant</label>
                            <input type="text" class="form-control my-3 px-2" id="capchat" name="capchat" placeholder="Entrez le texte suivant">
                        </div>
